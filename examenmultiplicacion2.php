...
<div class="radio-toolbar text-center">
   ...
   <input type="radio" name="ans"  value="ans1"id="1" ><label for="1">12</label>
   <input type="radio" name="ans"  value="ans2"id="2" ><label for="2">13</label>
   <input type="radio" name="ans"   value="ans3"id="3" ><label for="3">11</label>
   <input type="radio" name="ans"   value="ans4"id="4" ><label for="4">14</label>
  ...
  <h1>4 x 6</h1>
   <input type="radio" name="ans2" value="ans5"id="5" ><label for="5">24</label>
   <input type="radio" name="ans2" value="ans6"id="6" ><label for="6">21</label>
   <input type="radio" name="ans2" value="ans7" id="7" ><label for="7">23</label>
  <input type="radio" name="ans2" value="ans8" id="8" ><label for="8">22</label>
  ...
  <h1>4 x 8</h1>
  <input type="radio" name="ans3" value="ans9" id="9" ><label for="9">31</label>
  <input type="radio" name="ans3" value="ans10" id="10" ><label for="10">34</label>
 <input type="radio" name="ans3" value="ans11" id="11" ><label for="11">33</label>
   <input type="radio" name="ans3" value="ans12" id="12" ><label for="12">32</label>
  ...
  <h1>5 x 2</h1>
  <input type="radio" name="ans4" value="ans13" id="13" ><label for="13">14</label>
  <input type="radio" name="ans4" value="ans14" id="14" ><label for="14">12</label>
   <input type="radio" name="ans4" value="ans15" id="15" ><label for="15">10</label>
   <input type="radio" name="ans4" value="ans16" id="16" ><label for="16">11</label>
  ...
  <input type="radio" name="ans5" value="ans20" id="20" ><label for="20">29</label>
  ...
  <h1>5 x 8 </h1>
   <input type="radio" name="ans6" value="ans21"id="21" ><label for="21">41</label>
   <input type="radio" name="ans6" value="ans22" id="22" ><label for="22">40</label>
   <input type="radio" name="ans6" value="ans23"  id="23" ><label for="23">42</label>
  <input type="radio" name="ans5" value="ans24" id="24" ><label for="24">43</label>
  ...
  <h1>6 x 6</h1>
   ...
   <input type="radio" name="ans8" value="ans30" id="30" ><label for="30">35</label>
   <input type="radio" name="ans8" value="ans31"  id="31" ><label for="31">34</label>
  <input type="radio" name="ans8" value="ans32" id="32" ><label for="31">37</label>
  ...
  <h1>6 x 8</h1>
   <input type="radio" name="ans9" value="ans33"id="33" ><label for="33">47</label>
   <input type="radio" name="ans9" value="ans34" id="34" ><label for="34">48</label>
   <input type="radio" name="ans9" value="ans35"  id="35" ><label for="35">46</label>
  <input type="radio" name="ans9" value="ans36" id="36" ><label for="36">49</label>
  ...
  <h1>6 x 10</h1>
   <input type="radio" name="ans10" value="ans37"id="37" ><label for="37">60</label>
   <input type="radio" name="ans10" value="ans38" id="38" ><label for="38">61</label>
   <input type="radio" name="ans10" value="ans39"  id="39" ><label for="39">62</label>
  <input type="radio" name="ans10" value="ans40" id="40" ><label for="40">29</label>
