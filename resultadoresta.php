...
<head>
    ...
    <link rel="stylesheet" href="css/resutadosdeexamenes.css">
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white p-0"> <a class="navbar-brand mr-4" href="#"> <a class="logo"><img src="uaeh.png"></a><strong></strong></a> <button class="navbar-toggler mr-3" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                                ...
                                <div class="col-md-5">
                                    <div class="row d-flex tab">
                                        ...
                                        <div class="d-flex flex-column"> <a class="dropdown-item" href="sobrenosotros.html">
                                                <h6 class="mb-0">Sobre el Proyecto</h6> <small class="text-muted">Información </small>
                                            </a> </div>
                                    </div>
                                </div>
                                <div class="col-md-5">
                ...
                <li class="nav-item"> <a class="nav-link" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Exámenes Prueba  <span class="fas fa-book-open"></span></a>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4">
      ...
      <center> <h1>Resultados de la Prueba Restas</h1>  </center>
