...
<head>
    ...
    <title>Examen de Sumas</title>
    
    <link rel="stylesheet" href="css/examensuma.css">
...
<center><h1>Examen de Sumas</h1></center>
...
<center> 
   ...
   <input type="radio" name="ans"  value="ans1"id="1" ><label for="1">1</label>
   <input type="radio" name="ans"  value="ans2"id="2" ><label for="2">2</label>
   <input type="radio" name="ans"   value="ans3"id="3" ><label for="3">3</label>
   <input type="radio" name="ans"   value="ans4"id="4" ><label for="4">4</label>
...
<center>
  <h1>1 + 2</h1>
   <input type="radio" name="ans2" value="ans5"id="5" ><label for="5">3</label>
   <input type="radio" name="ans2" value="ans6"id="6" ><label for="6">5</label>
   <input type="radio" name="ans2" value="ans7" id="7" ><label for="7">7</label>
  <input type="radio" name="ans2" value="ans8" id="8" ><label for="8">9</label>
</center>
  </div>
...
<center>
  ...
  <h1>3 + 1</h1>
  <input type="radio" name="ans3" value="ans9" id="9" ><label for="9">4</label>
  <input type="radio" name="ans3" value="ans10" id="10" ><label for="10">6</label>
 <input type="radio" name="ans3" value="ans11" id="11" ><label for="11">3</label>
   <input type="radio" name="ans3" value="ans12" id="12" ><label for="12">5</label>
  ...
  <center>
  <h1>3 + 2</h1>
  <input type="radio" name="ans4" value="ans13" id="13" ><label for="13">4</label>
  <input type="radio" name="ans4" value="ans14" id="14" ><label for="14">6</label>
   <input type="radio" name="ans4" value="ans15" id="15" ><label for="15">5</label>
   <input type="radio" name="ans4" value="ans16" id="16" ><label for="16">8</label>
  ...
  <center>
  <h1>7 + 2</h1>
   <input type="radio" name="ans5" value="ans17"id="17" ><label for="17">0</label>
   <input type="radio" name="ans5" value="ans18" id="18" ><label for="18">10</label>
   <input type="radio" name="ans5" value="ans19"  id="19" ><label for="19">9</label>
  <input type="radio" name="ans5" value="ans20" id="20" ><label for="20">6</label>
</center>
  </div>
  ...
  <center>
  <h1>8 + 3</h1>
   <input type="radio" name="ans6" value="ans21"id="21" ><label for="21">13</label>
   <input type="radio" name="ans6" value="ans22" id="22" ><label for="22">11</label>
   <input type="radio" name="ans6" value="ans23"  id="23" ><label for="23">12</label>
  ...
  <center>
  <h1>7 + 7</h1>
   <input type="radio" name="ans7" value="ans25"id="25" ><label for="25">11</label>
   <input type="radio" name="ans7" value="ans26" id="26" ><label for="26">16</label>
   <input type="radio" name="ans7" value="ans27"  id="27" ><label for="27">15</label>
  <input type="radio" name="ans7" value="ans28" id="28" ><label for="28">14</label>
</center>
  </div>
  ...
  <center>
  <h1>8 + 9</h1>
   <input type="radio" name="ans8" value="ans29"id="29" ><label for="29">17</label>
   <input type="radio" name="ans8" value="ans30" id="30" ><label for="30">18</label>
  ...
  <center>
  <h1>10 + 10</h1>
   <input type="radio" name="ans9" value="ans33"id="33" ><label for="33">22</label>
   <input type="radio" name="ans9" value="ans34" id="34" ><label for="34">20</label>
   <input type="radio" name="ans9" value="ans35"  id="35" ><label for="35">25</label>
  <input type="radio" name="ans9" value="ans36" id="36" ><label for="36">26</label>
</center>
  </div>
  ...
  <center>
  <h1>12+13</h1>
   <input type="radio" name="ans10" value="ans37"id="37" ><label for="37">25</label>
   <input type="radio" name="ans10" value="ans38" id="38" ><label for="38">20</label>
   <input type="radio" name="ans10" value="ans39"  id="39" ><label for="39">24</label>
  <input type="radio" name="ans10" value="ans40" id="40" ><label for="40">26</label>
</center>
  </div>
...
<br>
  <br>
  <br>
 <center> <input  type="submit" value="¡Listo!" /> </center>
</form>
