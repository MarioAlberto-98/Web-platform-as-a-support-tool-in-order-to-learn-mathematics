...
<head>
    ...
    <title>Examen de Restas</title>
    
    <link rel="stylesheet" href="css/examenresta.css">
...
><h1>Examen de Restas</h1>

<form action="resultadoresta.php" method="post">
...
<div class="radio-toolbar">
   ...
   <input type="radio" name="ans"  value="ans1"id="1" ><label for="1">63</label>
   <input type="radio" name="ans"  value="ans2"id="2" ><label for="2">62</label>
   <input type="radio" name="ans"   value="ans3"id="3" ><label for="3">61</label>
   <input type="radio" name="ans"   value="ans4"id="4" ><label for="4">59</label>
  ...
  <h1>64 - 4</h1>
   <input type="radio" name="ans2" value="ans5"id="5" ><label for="5">62</label>
   <input type="radio" name="ans2" value="ans6"id="6" ><label for="6">61</label>
   <input type="radio" name="ans2" value="ans7" id="7" ><label for="7">60</label>
  <input type="radio" name="ans2" value="ans8" id="8" ><label for="8">63</label>
  ...
  <h1>68 - 57</h1>
  <input type="radio" name="ans3" value="ans9" id="9" ><label for="9">11</label>
  <input type="radio" name="ans3" value="ans10" id="10" ><label for="10">12</label>
 <input type="radio" name="ans3" value="ans11" id="11" ><label for="11">14</label>
   <input type="radio" name="ans3" value="ans12" id="12" ><label for="12">16</label>
  ...
  <h1>70 - 18</h1>
  <input type="radio" name="ans4" value="ans13" id="13" ><label for="13">55</label>
  <input type="radio" name="ans4" value="ans14" id="14" ><label for="14">54</label>
   <input type="radio" name="ans4" value="ans15" id="15" ><label for="15">52</label>
   <input type="radio" name="ans4" value="ans16" id="16" ><label for="16">53</label>
  ...
  <h1>75 - 45</h1>
   <input type="radio" name="ans5" value="ans17"id="17" ><label for="17">32</label>
   <input type="radio" name="ans5" value="ans18" id="18" ><label for="18">31</label>
   <input type="radio" name="ans5" value="ans19"  id="19" ><label for="19">30</label>
  <input type="radio" name="ans5" value="ans20" id="20" ><label for="20">33</label>
  ...
  <h1>77 - 56</h1>
   <input type="radio" name="ans6" value="ans21"id="21" ><label for="21">22</label>
   <input type="radio" name="ans6" value="ans22" id="22" ><label for="22">21</label>
   <input type="radio" name="ans6" value="ans23"  id="23" ><label for="23">25</label>
  <input type="radio" name="ans5" value="ans24" id="24" ><label for="24">23</label>
  ...
  <h1>79 - 46</h1>
   <input type="radio" name="ans7" value="ans25"id="25" ><label for="25">34</label>
   <input type="radio" name="ans7" value="ans26" id="26" ><label for="26">32</label>
   <input type="radio" name="ans7" value="ans27"  id="27" ><label for="27">35</label>
  <input type="radio" name="ans7" value="ans28" id="28" ><label for="28">33</label>
  ...
  <h1>82 - 65</h1>
   <input type="radio" name="ans8" value="ans29"id="29" ><label for="29">18</label>
   <input type="radio" name="ans8" value="ans30" id="30" ><label for="30">17</label>
   <input type="radio" name="ans8" value="ans31"  id="31" ><label for="31">15</label>
  <input type="radio" name="ans8" value="ans32" id="32" ><label for="31">16</label>
  ...
  <h1>84 - 45</h1>
   <input type="radio" name="ans9" value="ans33"id="33" ><label for="33">38</label>
   <input type="radio" name="ans9" value="ans34" id="34" ><label for="34">39</label>
   <input type="radio" name="ans9" value="ans35"  id="35" ><label for="35">37</label>
  <input type="radio" name="ans9" value="ans36" id="36" ><label for="36">36</label>
  ...
  <h1>89 - 77</h1>
   <input type="radio" name="ans10" value="ans37"id="37" ><label for="37">12</label>
   <input type="radio" name="ans10" value="ans38" id="38" ><label for="38">18</label>
   <input type="radio" name="ans10" value="ans39"  id="39" ><label for="39">15</label>
  <input type="radio" name="ans10" value="ans40" id="40" ><label for="40">16</label>
