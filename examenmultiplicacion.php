...
<div class="radio-toolbar text-center">
   ...
   <input type="radio" name="ans"   value="ans3"id="3" ><label for="3">4</label>
   <input type="radio" name="ans"   value="ans4"id="4" ><label for="4">5</label>
  ...
  <h1>2 x 1</h1>
   <input type="radio" name="ans2" value="ans5"id="5" ><label for="5">2</label>
   <input type="radio" name="ans2" value="ans6"id="6" ><label for="6">3</label>
   <input type="radio" name="ans2" value="ans7" id="7" ><label for="7">4</label>
  <input type="radio" name="ans2" value="ans8" id="8" ><label for="8">5</label>
  ...
  <h1>2 x 2</h1>
  <input type="radio" name="ans3" value="ans9" id="9" ><label for="9">5</label>
 ...
 <input type="radio" name="ans3" value="ans11" id="11" ><label for="11">3</label>
  ...
  <input type="radio" name="ans4" value="ans14" id="14" ><label for="14">2</label>
   <input type="radio" name="ans4" value="ans15" id="15" ><label for="15">6</label>
   <input type="radio" name="ans4" value="ans16" id="16" ><label for="16">7</label>
  ...
  <h1>2 x 5</h1>
   <input type="radio" name="ans5" value="ans17"id="17" ><label for="17">13</label>
   <input type="radio" name="ans5" value="ans18" id="18" ><label for="18">11</label>
   <input type="radio" name="ans5" value="ans19"  id="19" ><label for="19">10</label>
  <input type="radio" name="ans5" value="ans20" id="20" ><label for="20">14</label>
  ...
  <h1>2 x 8</h1>
   <input type="radio" name="ans6" value="ans21"id="21" ><label for="21">17</label>
   <input type="radio" name="ans6" value="ans22" id="22" ><label for="22">16</label>
   <input type="radio" name="ans6" value="ans23"  id="23" ><label for="23">15</label>
  <input type="radio" name="ans5" value="ans24" id="24" ><label for="24">18</label>
  ...
  <h1>2 x 9</h1>
   <input type="radio" name="ans7" value="ans25"id="25" ><label for="25">17</label>
   <input type="radio" name="ans7" value="ans26" id="26" ><label for="26">10</label>
   <input type="radio" name="ans7" value="ans27"  id="27" ><label for="27">15</label>
  <input type="radio" name="ans7" value="ans28" id="28" ><label for="28">18</label>
  ...
  <h1>3 x 4</h1>
   <input type="radio" name="ans8" value="ans29"id="29" ><label for="29">12</label>
   <input type="radio" name="ans8" value="ans30" id="30" ><label for="30">10</label>
   <input type="radio" name="ans8" value="ans31"  id="31" ><label for="31">15</label>
  <input type="radio" name="ans8" value="ans32" id="32" ><label for="31">11</label>
  ...
  <h1>3 x 7</h1>
   <input type="radio" name="ans9" value="ans33"id="33" ><label for="33">20</label>
   <input type="radio" name="ans9" value="ans34" id="34" ><label for="34">21</label>
  ...
  <h1>3 x 10</h1>
   <input type="radio" name="ans10" value="ans37"id="37" ><label for="37">30</label>
   <input type="radio" name="ans10" value="ans38" id="38" ><label for="38">31</label>
   <input type="radio" name="ans10" value="ans39"  id="39" ><label for="39">29</label>
  <input type="radio" name="ans10" value="ans40" id="40" ><label for="40">28</label>
